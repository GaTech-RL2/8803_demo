...
class Custom_Lift(SingleArmEnv):
    """
    ...
    def reward(self, action=None):
        ...
        # use a shaping reward
            ...
            # reaching reward
            cube_pos = self.sim.data.body_xpos[self.bowl_body_id]
    ...
    def _load_model(self):
        ...
        self.bowl = CustomObject(name="bowl", fpath="./assets/bowl102.xml")
    ...
    def _check_success(self):
        ...
        """
        cube_height = self.sim.data.body_xpos[self.bowl_body_id][2]
